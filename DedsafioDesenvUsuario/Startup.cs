...
using DesafioDesenvUsuario.Data.Repositorio;
using DesafioDesenvUsuario.Data.Repositorio.Interface;
using DesafioDesenvUsuario.Service.Servico;
...
namespace DedsafioDesenvUsuario
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BancoContexto>(option => option.UseSqlServer(Configuration.GetConnectionString("DataBase")));
